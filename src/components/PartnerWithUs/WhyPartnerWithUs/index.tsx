...
export const WhyPartnerWithUs = () => {
    const whyPartnerData = [
        ...
        },
        {
            ...
            description: "Our platform ensures a smooth and efficient process from onboarding to project completion."
        },
        {
            id: 4,
            logo: <EyeIcon />,
            ...
            description: "Detailed resource profiles enhance your visibility and increase your chances of being selected for projects."
        },
        {
            id: 5,
            logo: <GraphIcon />,
            ...
            description: "Join a network of professionals and vendors committed to delivering excellence and driving innovation."
        },
    ]
    return (
        <section>
                ...
                <div className="container">
                    <div className="flex flex-col gap-12 w-full max-w-[1040px] mx-auto">
                        <div className="text-center">
                            <h2 className="text-5xl leading-[62px] font-semibold inline-block bg-primary-gradient bg-clip-text text-fill-transparent">Why partner with HireQED.ai?</h2>
                        </div>
                        <div className="flex justify-center flex-wrap gap-6">
                            {whyPartnerData.map((items, index) => (
                                <div key={index} className="bg-white rounded-lg py-7 px-4 shadow-card min-h-[324px] basis-[calc(33.51%-18px)] hover:bg-primary-gradient group">
