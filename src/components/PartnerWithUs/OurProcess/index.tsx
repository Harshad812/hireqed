                    ...
                    <div className="bg-primary-gradient rounded-lg py-[88px] px-[118px]">
                        <div className="flex items-center justify-between gap-7">
                            <div className="flex flex-col gap-6 w-full max-w-[448px]">
                                <h2 className="text-white font-semibold text-5xl leading-[62px]">Our Process? It’s Simple.</h2>
                            ...
                            <div className="bg-white shadow-card rounded-lg px-8 pt-8 pb-16 w-full max-w-[586px]">
                                <div className="flex flex-col items-start gap-6">
                                    <div className="flex flex-col gap-3">
                                        <span className="inline-block bg-primary-gradient bg-clip-text text-fill-transparent font-medium text-xs">STEP 1</span>
                                        <h2 className="inline-block bg-primary-gradient bg-clip-text text-fill-transparent font-medium text-[40px] leading-[52px]">Get in Touch</h2>
                                    </div>
                                    <div>
