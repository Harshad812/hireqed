                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="">
                        <p className="text-xl leading-[26px] text-gray-600 font-normal font-sourceSans">
                          <b>Sign Up:</b> Begin by registering your organization
                          on HireQED.ai with our quick and easy sign-up process.
                        </p>
                        <p className="text-xl leading-[26px] text-gray-600 font-normal font-sourceSans">
                          <b>Access Granted:</b> Receive immediate access to our
                          comprehensive platform, tailored to meet all your
                          hiring needs
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex flex-row-reverse justify-between items-center">
                  ...
                  <div className="shadow-card rounded-lg pt-8 pb-16 px-8 w-full max-w-[589px]">
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="">
                        <p className="text-xl leading-[26px] text-gray-600 font-normal font-sourceSans">
                          Define your project requirements, timelines, and
                          specific needs. Whether it’s a short-term assignment
                          or a long-term project, our platform allows you to set
                          up multiple projects with ease.
                        </p>
                      </div>
                    </div>
                  </div>
